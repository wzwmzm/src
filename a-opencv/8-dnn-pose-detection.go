...
// go run 8-dnn-pose-detection.go 0 data/pose_iter_440000.caffemodel data/openpose_pose_coco.prototxt

// go run 8-dnn-pose-detection.go 0 data/pose_iter_102000.caffemodel data/pose_deploy.prototxt
