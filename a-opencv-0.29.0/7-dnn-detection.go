...
// 
//              go run 7-dnn-detection.go 0 data/res10_300x300_ssd_iter_140000.caffemodel  data/deploy.prototxt

//              go run 7-dnn-detection.go 0 data/frozen_inference_graph.pb  data/ssd_mobilenet_v1_coco_2017_11_17.pbtxt
// +build example
